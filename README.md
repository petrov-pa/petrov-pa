...
| ------------- |:-------------:| -----|
| [распознавание номеров для автоматизации КПП](https://github.com/vederko-p/plates_recognition)      | Kaggle | Нейронная сеть, которая классифицирует музыку по жанрам. Код упакован в Docker контейнер и может быть запущен, как Flask приложение |
